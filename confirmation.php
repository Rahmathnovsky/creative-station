...
<head>
  ...
  <meta property="twitter:image:src" content="./assets/images/logo-agency.png">
  ...
  <title>Agency - Register </title><!-- Styles-->
              ...
              <div class="header-content">
                <nav class="nav-menu flex-grow-1">
                  <div class="logo flex-grow-1 start-mobile">
                    <a href="index.html">
                      <span class="logo-main landscape medium"><img src="./assets/images/logo-agency.png" alt="logo"/>Agency</span>
                    </a>
                  </div>
                  <nav class="user-menu">
                      ...
                      <div class="col-md-6 px-lg-6 px-2">
                        <div class="card form-box fragment-fadeUp">
                          <div class="form-wrap">
                            <div class="form-style">
                              <div class="head">
                                <h4 class="use-text-title mq-md-up use-text-primary" data-class="use-text-subtitle">Create new account</h4>
                              </div>
                              ...
                              <form id="contact-form" method="post" action="api/Kirim_form/send_email">
                                <div class="row spacing3 mb-0">
                                  <div class="col-sm-12">
                                    <div class="input-field">
                                      <input class="validate" type="text" name="name" placeholder="{{lgg('contact_form_name')}} *" required />
                                      
                                    </div>
                                  </div>
                                  <div class="col-sm-12">
                                    <div class="input-field">
                                      <input class="validate" type="email" name="email" placeholder="{{lgg('contact_form_email')}} *" required />
                                      
                                    </div>
                                  </div>
                                  <div class="col-sm-12">
                                    <div class="input-field">
                                      <input class="validate" type="text" name="subject" placeholder="{{lgg('contact_form_title')}} *" required />
                                      
                                    </div>
                                  </div>
                                  <div class="col-sm-12">
                                    <div class="input-field">
                                      <input class="validate" type="text" name="description" placeholder="{{lgg('contact_form_desc')}} *" required />
                                ...
                                <div class="btn-area">
                                  ...
                                  <div class="mt-4"><button class="btn primary btn-large waves-effect" type="submit" id="btnSubmitForm">Submit</button></div>
                                </div>
                              </form>
                            </div>
                          </div>
                        ...
                        <div class="hidden-sm-down">
                          <div class="greeting">
                            ...
                            <div class="img">
                              ...
                              <img class="img-2d3d" src="./assets/images/agency/register_3D@2x.png" data-2d="./assets" data-3d="./assets/images/agency/register_3D@2x.png" alt="registes" />
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="container mq-sm-down" data-class="fixed-width">
                <div class="row">
                  <div class="col-md-3 pa-lg-4 logo-area">
                    ...
                    <p class="body-2">We work with international startups, help entrepreneurs launch for the long term.</p>
