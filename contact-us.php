...
<head>
  <meta charset="utf-8">
  <meta name="description" content="Digital Service Platform - Simsalabim.ds">
  <meta name="viewport" content="minimum-scale=1, initial-scale=1, width=device-width, shrink-to-fit=no"><!-- Favicon-->
  <link rel="shortcut icon" href="./assets/favicons/simsalabim-icon.png" type="image/x-icon">
  ...
  <meta property="twitter:image:src" content="./assets/images/simsalabim-icon.png">
  <meta property="og:url" content="nirwana.indisains.com/agency">
  <meta property="og:title" content="Simsalabim">
  <meta property="og:description" content="Digital Service Platform - Simsalabim.ds">
            ...
            <div class="side-multilv">
              <div class="collection side-multilv">
                <ul class="collapsible expandable">
                  <li class="collection-item"><a class="sidenav-close waves-effect menu-list text-white" href="products.html">Products</a></li>
                  <li class="collection-item"><a class="sidenav-close waves-effect menu-list text-white" href="our-teams.html">Teams</a></li>
                  <li class="collection-header" style="color:#87CEEB;">&copy; Creative in 2022</li>
                      ...
                      <div class="collection side-group">
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list" href="products.html">Products</a>
                          </li>
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="about-team.html">team</a>
                          </li>
                          <li class="collection-item side-group-link">
              ...
              <!-- <div class="collection">
                <ul>
                  <li class="collection-item">
                    <a class="sidenav-close waves-effect menu-list" href="#">Login</a>
                  </li>
                  <li class="collection-item">
                    <a class="sidenav-close waves-effect menu-list" href="#">Register</a>
                  </li>
                </ul>
              </div> -->
            </div>
          </div>
          <header class="app-bar header" id="header" style="background-color: #051326;">
            <div class="container">
              <div class="header-content">
                <nav class="nav-menu">
                  <button class="btn-icon waves-effect sidenav-trigger hamburger hamburger--spin show-md-down" id="mobile_menu" type="button" data-target="slide_menu"><span class="hamburger-box mt-2"><span class="bar hamburger-inner"></span></span></button>
                  <div class="logo">
                    <a href="index.html">
                      <span class="text-white logo-main landscape medium"><img src="./assets/images/simsalabim-icon.png" alt="logo"/></span>
                    </a>
                  </div>
                  <div class="scrollactive-nav scrollnav show-lg-up multi-menu">
                    <ul class="main-menu">
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect text-white" href="products.html">Products</a>
                      </li>
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect text-white" href="our-teams.html">Teams</a>
                      </li>
                      <!--<li>
                        <a class="btn btn-flat anchor-link waves-effect" href="index.html#expertise">our expertise</a>
                      </li>
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect" href="index.html#case-studies">case studies</a>
                      </li>
                      <li>
                            ...
                            <div class="container max-md">
                              <div class="row">
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">Company</div>
                                  <img class="thumb-menu" src="./assets/images/agency/menu_marketing@2x.jpg" alt="thumbnail" />
                                  <ul>
                                    <li class="waves-effect"><a class="menu-list" href="about.html">about</a></li>
                                    <li class="waves-effect"><a class="menu-list current" href="about-team.html">team and culture</a></li>
                                ...
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">Form</div>
                                  <img class="thumb-menu" src="./assets/images/agency/menu_education@2x.jpg" alt="thumbnail" />
                                  <ul>
                                ...
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">Items</div>
                                  <img class="thumb-menu" src="./assets/images/agency/menu_pos@2x.jpg" alt="thumbnail" />
                                  <ul>
                                ...
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">Utilities</div>
                                  <img class="thumb-menu" src="./assets/images/agency/menu_saas2@2x.jpg" alt="thumbnail" />
                                  <ul>
                  ...
                  <nav class="user-menu">
                    <!-- <a class="btn btn-flat waves-effect show-sm-up text-white" href="#">Login</a>
                    <a class="btn waves-effect show-sm-up" style="background-color: #5F9EA0;" href="#">register</a> -->
                    ...
                    <!-- <div class="menu-setting">
                        <div class="setting">
                          <button class="btn btn-icon waves-effect btn-small dropdown-trigger ma-1" data-target="dropdown_config" data-align="left" type="button">
                            <i class="icon material-icons" id="setting_icon" style="color: #ffff;">settings</i>
                          </button>
                          <div class="dropdown-content setting" id="dropdown_config">
                            <ul class="collection with-header">
                              <li class="collection-header">&copy; Creative in 2022</li>
          ...
          <div id="footer" style="background-color: #051326;">
            <footer class="footer-sitemap">
              ...
              <div class="container mq-sm-down" data-class="fixed-width">
                <div class="row">
                  <div class="col-md-3 pa-lg-4 logo-area mt-4">
                    <div class="logo">
                      <span class="logo-main text-white landscape medium"><img src="./assets/images/simsalabim-icon.png" alt="logo"/>Simsalabim</span>
                    </div>
                    <p class="body-2 text-white">We work with international startups, help entrepreneurs launch for the long term.</p>
                    <p class="body-2 hidden-sm-down" style="color: #FFA300;">&copy; Creative in 2022</p>
                  </div>
                  <div class="col-md-6 pa-4 mt-4">
                    <ul class="show-sm-down collapsible">
                      <li class="accordion-content">
                        <div class="collapsible-header">
                          <h6 class="title text-white">Company</h6><i class="material-icons right arrow">expand_more</i>
                        </div>
                        <div class="collapsible-body">
                          <ul>
                            <li><a href="#team" style="color: #87CEEB;">Team</a></li>
                            <li><a href="#history" style="color: #87CEEB;">History</a></li>
                            <li><a href="contact-us.php" style="color: #87CEEB;">Contact us</a></li>
                            <li><a href="#locations" style="color: #87CEEB;">Locations</a></li>
                          </ul>
                        </div>
                      </li>
                      <!-- <li class="accordion-content">
                        <div class="collapsible-header">
                          <h6 class="title text-white">Resources</h6><i class="material-icons right arrow">expand_more</i>
                        </div>
                        <div class="collapsible-body">
                          <ul>
                      ...
                      <li class="accordion-content">
                        <div class="collapsible-header">
                          <h6 class="title text-white">Legal</h6><i class="material-icons right arrow">expand_more</i>
                        </div>
                        <div class="collapsible-body">
                          <ul>
                            <li><a href="privacy-policy.html" style="color: #87CEEB;">Privacy policy</a></li>
                            <li><a href="term-of-use.html" style="color: #87CEEB;">Terms of use</a></li>
                          </ul>
                        </div>
                      </li>
                    </ul>
                    <div class="row show-md-up justify-content-around">
                      <div class="col pa-4 site-map-item">
                        <h6 class="title text-white mb-4">Company</h6>
                        <ul>
                          <li><a href="#team" style="color: #87CEEB;">Team</a></li>
                          <li><a href="#history" style="color: #87CEEB;">History</a></li>
                          <li><a href="contact-us.php" style="color: #87CEEB;">Contact us</a></li>
                      ...
                      <!-- <div class="col pa-4 site-map-item">
                        <h6 class="title text-white mb-4">Resources</h6>
                        <ul>
                          <li><a href="#resource">Resource</a></li>
                          <li><a href="#resource-name">Resource name</a></li>
                          <li><a href="#another-resource">Another resource</a></li>
                      ...
                      <div class="col pa-4 site-map-item">
                        <h6 class="title text-white mb-4">Legal</h6>
                        <ul>
                          <li><a href="privacy-policy.html" style="color: #87CEEB;">Privacy policy</a></li>
                          <li><a href="term-of-use.html" style="color: #87CEEB;">Terms of use</a></li>
                        </ul>
                  ...
                  <div class="col-md-3 pa-4 mt-4">
                    <div class="socmed">
                      <a class="btn btn-icon waves-effect" href="#"><span class="ion-social-facebook icon"></span></a>
                      <a class="btn btn-icon waves-effect" href="https://www.instagram.com/simsalabim.ds/"><span class="ion-social-instagram icon"></span></a>
                      <a class="btn btn-icon waves-effect" href="https://www.linkedin.com/in/simsalabim-ds-34120a252/"><span class="ion-social-linkedin icon"></span></a>
                    </div>
                    ...
                    <p class="body-2 mt-5 text-center hidden-md-up" style="color: #FFA300;">&copy; Creative in 2022</p>
                  </div>
                </div>
              </div>
            </footer>
